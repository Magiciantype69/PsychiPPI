...
output = open(r'E:\OneDrive\学术\PPI article\data\mapped data\3. DNM_complex_mapping\ALL_Complex_PPI_mutation_sites_allonco.txt','w+')
...
with open(r'E:\OneDrive\学术\PPI article\data\mapped data\0.data filter\InterfacesHQ_with_detail.txt') as fp:
    ...
    for line in fp:
        ...
        AAchange_Mutation_on_interface = []
