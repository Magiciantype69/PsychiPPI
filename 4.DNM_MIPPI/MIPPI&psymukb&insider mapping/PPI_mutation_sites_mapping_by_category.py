...
print("PPI_mutation_sites_mapping_by_category")
Disease_list = []
Category_list =[]
Disease_category = {}
...
for category in Category_list:
    ...
    outputdir = outputdir1 +category +outputdir2
    ...
    opendir = opendir1+ category + opendir2
                        ...
                        for i in P2_Protein_Change_list:
                            ...
                            if int(P2_mutation_site[0]) in interfaces_P2:
                                ...
                                if P2_Poly_score !='.':
                                    ...
                                    type_Poly = 'unknown'
                                P2_PPI_mutations_SIFT.append(type_SIFT+'('+str(P1_SIFT_score)+')')
                                P2_PPI_mutations_PolyPhen.append(type_Poly+'('+str(P1_Poly_score)+')')
...
output.close()
print('PPI_mutation_sites_mapping by category is done')
