...
print("ALL_PPI_mutation_sites_mapping_with_allonco")
output = open(r'E:\OneDrive\学术\PPI article\data\mapped data\3. DNM_complex_mapping\ALL_Complex_PPI_mutation_sites_allonco_newtest.txt','w+')
...
with open(r'E:\OneDrive\学术\PPI article\data\mapped data\0.data filter\InterfacesHQ_with_detail.txt') as fp:
    ...
    for line in fp:
        ...
        with open(r'E:\OneDrive\学术\PPI article\data\mapped data\1. DNM_on_interface_mapping\All_DNM_Protein_mutation_mapping.txt') as md:
            for row in md:
                P1_mutation_list = []
                P2_mutation_list = []
                P1_SIFT_score = ''
                ...
                UniprotID = mapping[0]; GeneID = mapping[1] ;Gene_refGene = mapping[2]; PrimaryPhenotype = mapping[4] ; DisorderCategory = mapping[5]
...
output.close()
print('All_PPI_mutation_sites_mapping is done')
