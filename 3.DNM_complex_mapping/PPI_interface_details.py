...
with open(r'E:\OneDrive\学术\PPI article\data\other\entreID.txt') as fp:
    fp.readline()
    for line in fp:
        line = line.strip()
        temp= line.split('\t')
...
InterfacesHQ_with_detail = open(r'E:\OneDrive\学术\PPI article\data\mapped data\0.data filter\interfacesHQ_with_detail.txt','w+')
